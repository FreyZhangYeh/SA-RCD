...
--depths_in_use radar radar_dilation conf_map \
...
--train_response_path training/nuscenes/nuscenes_train_conf_attwp.txt \
...
--val_response_path testing/nuscenes/nuscenes_test_conf_attwp.txt \
...
--n_thread 8 \
--disc study_of_SAG_CBAM_AAP_CONF \
--seed 40