...
--restore_path trained_fusionnet/0721141945__Lfunc_l1_wdenseL_1.0_wlidarL_2.0_wpercepL_0.0_wsmoothness_0.0_fusiontype_add_output_type_res_total_epoch_300--Input-mono-r-srd_Out-res_GPU_2/model-400000.pth \
...
--radar_dilation_path testing/nuscenes/nuscenes_test_selected_dilation_radar.txt \
