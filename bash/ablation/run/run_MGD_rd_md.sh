...
--restore_path trained_fusionnet/0808135518__Lfunc_l1_wdenseL_1.0_wlidarL_2.0_wpercepL_0.0_wsmoothness_0.0_fusiontype_add_output_type_res_total_epoch_300--Input-mono-r-rd_Out-res_GPU_6/model-440000.pth \
...
--radar_dilation_path testing/nuscenes/nuscenes_test_radar_dilation.txt \
