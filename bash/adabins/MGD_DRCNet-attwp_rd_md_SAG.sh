...
--train_radar_dilation_path training/nuscenes/nuscenes_train_selected_dilation_radar_adabins.txt \
...
--val_radar_dilation_path testing/nuscenes/nuscenes_test_selected_dilation_radar_adabins.txt \
