...
--train_conf_ground_truth_path training/nuscenes/nuscenes_train_conf_gt_adabins.txt \
--val_image_path testing/nuscenes/nuscenes_test_image.txt \
--val_radar_path testing/nuscenes/nuscenes_test_radar_dilation_adabins.txt \
--val_conf_ground_truth_path testing/nuscenes/nuscenes_test_conf_gt_adabins.txt \
--batch_size 16 \
--n_height 352 \
--n_width 704 \
