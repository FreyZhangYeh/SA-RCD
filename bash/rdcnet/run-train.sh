...
--image_path training/nuscenes/nuscenes_train_image.txt \
--radar_path training/nuscenes/nuscenes_train_radar_dilation_adabins.txt \
--conf_ground_truth_path training/nuscenes/nuscenes_train_conf_gt_adabins.txt \
...
--w_positive_class 10 \
--response_thr 0.5 \
--output_dirpath /data/zfy_data/nuscenes/nuscenes_derived/rdcnet-adabins \
