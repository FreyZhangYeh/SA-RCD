...
--restore_path trained_rdcnet/0806204959__Input_rd--Input-rd_Loss-ce_FT-wp_GPU_4/model-343000.pth \
--image_path testing/nuscenes/nuscenes_test_dany_metric_predicted.txt \
--radar_path testing/nuscenes/nuscenes_test_radar_dilation.txt \
--conf_ground_truth_path testing/nuscenes/nuscenes_test_conf_gt.txt \
...
--rcnet_fusion_type weight_and_project \
--rcnet_fusion_layers weight_and_project weight_and_project weight_and_project weight_and_project weight_and_project weight_and_project \
...
--w_positive_class 10 \
--response_thr 0.5 \
--output_dirpath /data/zfy_data/nuscenes/nuscenes_derived_test/rdcnet-mono-wp \
